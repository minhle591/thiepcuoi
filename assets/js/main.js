...
const DEFAULT_EVENT_DETAILS = {
  "2026-02-01": {
    ...
    items: [
      "15:00: Bữa ăn thân mật tại nhà trai",
      "16:00: Bữa ăn thân mật tại nhà trai",
      "17:30: Bữa ăn thân mật tại nhà gái",
    ],
  },
  "2026-02-02": {
    ...
    items: [
      ...
      "11:00: Lễ Thành Hôn tổ chức tại tư gia nhà trai",
    ],
  },
};

const EVENT_DETAILS_BY_PAGE = {
  "nhagai-an": {
    "2026-02-01": {
      title: "Chủ nhật 01/02/2026",
      items: ["17:30: Bữa ăn thân mật tại tư gia nhà gái"],
    },
  },
  "nhagai-vuquy": {
    "2026-02-01": {
...
const initCountdown = () => {
  ...
  const targetValue =
    countdownSection?.dataset.countdownTarget || "2026-02-02T11:00:00+07:00";
  let target = new Date(targetValue);
  if (Number.isNaN(target.getTime())) {
    target = new Date("2026-02-02T11:00:00+07:00");
  }
...
const initCalendar = () => {
  ...
  const eventDetails = EVENT_DETAILS_BY_PAGE[pageKey] || DEFAULT_EVENT_DETAILS;

  const openModal = (dateKey) => {
    const detail = eventDetails[dateKey];
    if (!detail) return;
